...
> No internal COGS, pricing, or revenue data was used.

---

## Why a Product Ladder Matters for Revenue Operations

Without a product ladder, revenue is just a blended number. With a product ladder, the operator can see:

- Which product acquires the customer?
- Which product retains them?
- Which product maximizes margin?
- Which product builds the subscription relationship?
- Which product wins at gifting?

Each rung of the ladder should have a distinct commercial role, a target segment, a channel strategy, and a post-purchase follow-up path. Operating all products as a single "tea shop" obscures all of this.
...
**Commercial role:** Acquire new buyers with the lowest friction format. Price point and format accessibility enable first purchase without commitment. These products introduce Dorje's quality bar and estate story to buyers who have not tried premium whole-leaf tea before.
...
- Packaging: lighter (teabag format)
- Shipping cost per order: may dominate margin if ordered solo
...
**Funnel role:** Retention and replenishment anchor. The goal is to convert a one-time buyer into a predictable monthly orderer, then into a subscriber.

**Expected margin profile [SYNTHETIC]:**
- AOV: moderate (100g–250g pack, solo order)
- Packaging: standard premium (not gift-level)
- Replenishment cycle: 21–30 days for 100g at daily consumption
...
**Commercial role:** Drive premium first purchase and Darjeeling Loyalist acquisition. First Flush Darjeeling is Dorje's highest-differentiation, highest-intent seasonal product. Buyers who purchase First Flush Darjeeling are making a deliberate choice about provenance, not just convenience.

**Target segment:** Darjeeling Loyalist, Climate/Story-Led Buyer, Daily Premium Tea Drinker (upgrading)

**Funnel role:** High-conviction acquisition. First Flush buyers typically have the highest AOV, highest repeat rate, and highest subscription attach potential of any segment. They should be treated as the highest-value acquisition target.
...
**Funnel role:** LTV maximizer. A subscriber has near-zero re-acquisition cost on subsequent orders and higher LTV than an equivalent non-subscriber buyer.
...
**Funnel role:** Revenue spike management. Gifting is seasonal and event-driven. The operating system should plan for gifting campaigns separately from always-on acquisition, with separate landing pages, separate contribution margin assumptions (premium packaging cost), and separate post-purchase flows.
...
## Offer Architecture Operating Rules

1. **Each product rung should have its own landing page.** A Gift Buyer landing on the same page as a Daily Premium Tea Drinker will convert at half the rate of a segment-specific page.
...
5. **Track cross-rung movement.** The most important conversion in the ladder is: Discovery → Daily Replenishment → Subscription. And for gifting: Gift Buyer → Self-Purchaser → Daily Replenishment.

6. **Do not discount Rung 3, 4, or 6.** Price integrity on premium, subscription, and limited-edition products is what makes them premium.
